...
@section('content')
<div class="container pt-2 pb-5" style="font-family: 'Inter', 'Segoe UI', Arial, sans-serif; background: #f4f7fb; min-height: 100vh;">
   <div class="row justify-content-center">
	   <!-- Main Content -->
	   <div class="col-12 d-flex justify-content-center" style="margin-top:-1.5rem;">
