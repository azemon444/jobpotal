   ...
   <div class="row justify-content-center">
	   ...
	   <div class="col-12 d-flex justify-content-center">
		   <div class="profile-main-modern bg-white border-0 shadow-lg rounded-4" style="max-width:1100px;width:90vw;padding:2.5rem 3.5rem 2rem 3.5rem; margin-top:0;">
				   <!-- Removed Account Settings header for a cleaner look -->
				<div class="row mb-3">
					<div class="col-12">
						   <div class="profile-section-card rounded-4 shadow-sm bg-white mb-4" style="max-width:1000px;margin:auto;padding:2rem 2.5rem;">
							   <div class="d-flex flex-row align-items-center justify-content-between flex-wrap gap-4 mb-3">
								   <div class="profile-avatar-wrapper position-relative" style="min-width:110px;">
								   ...
								   <div class="flex-grow-1 ms-3">
									   ...
									   <div class="text-muted mb-1">{{ $profile->address ?? '' }}</div>
								   ...
								   <div class="d-flex flex-column gap-1" style="min-width:180px;">
									   <div class="d-flex align-items-center mb-1"><i class="fas fa-phone text-primary me-2"></i><span>{{ $profile->phone ?? '' }}</span></div>
									   <div class="d-flex align-items-center mb-1"><i class="fas fa-birthday-cake text-primary me-2"></i><span>{{ $profile->dob ?? '' }}</span></div>
									   <div class="d-flex align-items-center mb-1"><i class="fas fa-venus-mars text-primary me-2"></i><span>{{ $profile->gender ?? '' }}</span></div>
									   <div class="d-flex align-items-center mb-1"><i class="fas fa-flag text-primary me-2"></i><span>{{ $profile->nationality ?? '' }}</span></div>
								   </div>
							   </div>
						   </div>
						   <div class="row g-3 mb-3">
							   ...
							   <div class="col-md-6">
								   ...
								   <div class="card shadow-sm rounded-4 mb-3">
									   <div class="card-body">
										   <h5 class="fw-bold mb-2"><i class="fas fa-lightbulb text-primary me-2"></i>Skills</h5>
										   <div class="ps-1">
											   @foreach(explode(',', $profile->skills) as $skill)
												   <span class="badge bg-primary bg-opacity-10 text-primary fw-semibold me-2 mb-2" style="font-size:1em; border-radius:1em;">{{ trim($skill) }}</span>
											   @endforeach
										   </div>
									   </div>
								   </div>
