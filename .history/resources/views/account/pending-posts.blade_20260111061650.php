                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div style="display: flex; align-items: flex-start; justify-content: space-between;">
                                    ...
                                    <form action="{{ route('admin.sendFeedback', $post->id) }}" method="POST" style="min-width:140px; max-width:180px; margin-left:10px; float:right;">
                                        @csrf
                                        <textarea name="admin_feedback" class="form-control mb-1" rows="1" style="resize:none; min-height:28px; max-height:40px; font-size:0.95em;" placeholder="Comment...">{{ $post->admin_feedback }}</textarea>
