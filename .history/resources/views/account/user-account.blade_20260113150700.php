...
<div class="container py-5" style="font-family: 'Inter', 'Segoe UI', Arial, sans-serif; background: #f4f7fb; min-height: 100vh;">
   <div class="row justify-content-center">
	   ...
	   <div class="col-12 d-flex justify-content-center">
		   <div class="profile-main-modern bg-white border-0 shadow-lg rounded-5 px-4 px-md-5 py-5" style="max-width: 600px; width: 100%; margin: 0 auto;">
				<h4 class="fw-bold mb-4 text-primary"><i class="fas fa-user-circle me-2"></i>Account Settings</h4>
				<div class="row mb-3">
					<div class="col-12">
						<div class="profile-section-card p-5 rounded-4 shadow-sm bg-white mb-4" style="max-width:1100px;margin:auto;">
