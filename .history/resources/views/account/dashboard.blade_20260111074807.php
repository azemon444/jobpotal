...
@section('content')
    <div style="background: #f8f9fa;">
        ...
        <div class="account-bdy p-4">
                ...
                @if(Auth::user()->hasRole('user') || Auth::user()->hasRole('jobseeker'))
                    <!-- Place 'Apply Now' and 'Saved Jobs' buttons here if needed for users/jobseekers only -->
                @endif
                        <div class="col-md-2 col-6 mb-3">
                                        ...
                                        @foreach(App\Models\Post::where('status','pending')->with('company')->get() as $post)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- ...existing code... (no comment form or reply display) ... -->
