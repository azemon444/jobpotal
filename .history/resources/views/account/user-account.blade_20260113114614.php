	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-8 col-md-7 col-12">
			<div class="profile-main-modern p-5 bg-white border-0 shadow-lg h-100 rounded-4">
				<h4 class="fw-bold mb-4 text-primary"><i class="fas fa-user-circle me-2"></i>Account Settings</h4>
				<div class="row mb-3">
					<div class="col-12">
						<div class="profile-section-card p-5 rounded-4 shadow-sm bg-white mb-4" style="max-width:1400px;margin:auto;">
						...
						<div class="row g-4">
							<div class="col-12 col-md-6 col-lg-4">
								<div class="profile-section-card p-4 rounded-4 shadow-sm bg-white mb-4 h-100">
									<h5 class="fw-bold mb-2"><i class="fas fa-phone text-primary me-2"></i>Contact</h5>
									<div class="mb-2"><i class="fas fa-phone me-2"></i>{{ $profile->phone ?? '' }}</div>
									<div class="mb-2"><i class="fas fa-birthday-cake me-2"></i>{{ $profile->dob ?? '' }}</div>
									<div class="mb-2"><i class="fas fa-venus-mars me-2"></i>{{ $profile->gender ?? '' }}</div>
									<div class="mb-2"><i class="fas fa-flag me-2"></i>{{ $profile->nationality ?? '' }}</div>
								</div>
							</div>
							<div class="col-12 col-md-6 col-lg-8">
								<div class="profile-section-card p-4 rounded-4 shadow-sm bg-white mb-4 h-100">
									<h5 class="fw-bold mb-2"><i class="fas fa-info-circle text-primary me-2"></i>About</h5>
									<div>{{ $profile->about ?? 'No about info provided.' }}</div>
								</div>
