		...
		<div class="col-lg-8 col-md-7 col-12">
			<div class="profile-main-modern p-5 bg-white border-0 shadow-lg h-100 rounded-4">
				...
				<div class="row g-4 mb-3">
					<div class="col-12">
						<div class="profile-section-card p-4 rounded-4 shadow-sm bg-white mb-4">
							<div class="d-flex align-items-center mb-3">
								<i class="fas fa-user-circle fa-2x text-primary me-3"></i>
								<div>
									<h5 class="mb-0 fw-bold">{{ $profile->full_name ?? '' }}</h5>
									<div class="text-muted small">{{ $profile->address ?? '' }}</div>
								</div>
							</div>
							<div class="row g-3">
								<div class="col-md-6">
									<div class="d-flex align-items-center mb-2"><i class="fas fa-envelope text-primary me-2"></i><span>{{ auth()->user()->email }}</span></div>
						...
						<div class="profile-section-card p-4 rounded-4 shadow-sm bg-white mb-4">
							<div class="d-flex align-items-center mb-3">
								...
								<h5 class="mb-0 fw-bold">Education</h5>
							</div>
						...
						<div class="profile-section-card p-4 rounded-4 shadow-sm bg-white mb-4">
							<div class="d-flex align-items-center mb-3">
								...
								<h5 class="mb-0 fw-bold">Experience</h5>
							</div>
						...
						<div class="profile-section-card p-4 rounded-4 shadow-sm bg-white mb-4">
							<div class="d-flex align-items-center mb-3">
								...
								<h5 class="mb-0 fw-bold">References</h5>
							</div>
