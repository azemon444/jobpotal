                        ...
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <div style="display: flex; flex-direction: row; align-items: flex-start; gap: 10px; justify-content: flex-start; width:100%;">
                                    ...
                                    <!-- Middle: Comment field and Send button -->
                                    <form action="{{ route('admin.sendFeedback', $post->id) }}" method="POST" style="min-width:120px; max-width:160px; margin-top:0; display:flex; flex-direction:column; align-items:flex-start; gap:2px;">
                                        @csrf
