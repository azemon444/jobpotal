	...
	<div class="row justify-content-center">
		...
		<div class="col-lg-8 col-md-7 col-12">
			<div class="profile-main-modern p-5 bg-white border-0 shadow-lg h-100 rounded-4">
				...
				<div class="row mb-3">
					<div class="col-12">
						<div class="profile-section-card p-5 rounded-4 shadow-sm bg-white mb-4" style="max-width:1400px;min-width:600px;width:90vw;margin:auto;">
							...
							<div class="info-blocks-list mb-4">
								<div class="info-block-row d-flex align-items-center mb-3 p-3 bg-light rounded-3 shadow-sm">
								...
								<div class="info-block-row d-flex align-items-center mb-3 p-3 bg-light rounded-3 shadow-sm">
									...
									<span class="fw-semibold me-2">Date of Birth:</span>
									<span>{{ $profile->dob ?? '' }}</span>
								</div>
								<div class="info-block-row d-flex align-items-center mb-3 p-3 bg-light rounded-3 shadow-sm">
									<i class="fas fa-venus-mars text-primary me-3"></i>
									<span class="fw-semibold me-2">Gender:</span>
									<span>{{ $profile->gender ?? '' }}</span>
								</div>
								<div class="info-block-row d-flex align-items-center mb-3 p-3 bg-light rounded-3 shadow-sm">
									<i class="fas fa-flag text-primary me-3"></i>
									<span class="fw-semibold me-2">Nationality:</span>
