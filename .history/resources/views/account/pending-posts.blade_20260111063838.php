                    ...
                    <tbody style="text-align:center; vertical-align:middle;">
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <div style="display: flex; flex-direction: row; align-items: center; gap: 10px; justify-content: flex-start;">
                                    <a href="{{ route('post.show', $post->id) }}" class="btn btn-info btn-sm px-3" style="border-radius:2em; font-weight:500;">View</a>
                                    ...
                                    <form action="{{ route('admin.sendFeedback', $post->id) }}" method="POST" style="min-width:120px; max-width:160px; margin-top:0; display:inline-block;">
                                        @csrf
