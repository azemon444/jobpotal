...
// Removed /profile routes. Use /account/overview instead.
...
Route::middleware('auth')->prefix('account')->group(function () {
  ...
  Route::get('jobseeker/{user}', [AccountController::class, 'jobseekerProfile'])->name('account.jobseekerProfile');
  ...
  Route::get('edit', [AccountController::class, 'editProfile'])->name('account.edit');
  Route::post('edit', [AccountController::class, 'updateProfile'])->name('account.update');
  //savedJobs
  ...
  // My Applications (for jobseekers)
  Route::get('my-applications', [JobApplicationController::class, 'myApplications'])->name('jobApplication.myApplications');
  ...
  Route::post('pending-posts/{id}/feedback', [AdminController::class, 'sendFeedback'])->name('admin.sendFeedback');
  ...
  Route::post('post/{id}/reply-feedback', [App\Http\Controllers\AccountController::class, 'replyFeedback'])->name('author.replyFeedback');
