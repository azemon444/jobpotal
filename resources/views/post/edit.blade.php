        ...
        <div class="col-sm-12 col-md-12">
          <form action="{{route('post.update',['post'=>$post])}}" id="postForm" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" placeholder="e.g. Communication, PHP, Marketing" class="form-control @error('skills') is-invalid @enderror" name="skills" value="{{ $post->skills }}" required >
            </div>
