  ...
  <div class="footer-main">
    <div class="container">
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="footer-links">
            <h3 class="footer-brand mb-2">JobPortal</h3>
            <div class="footer-link-list">
             <a href="#" class="footer-links"><i class="fas fa-compass"></i> 12 Kawran Bazar, Dhaka 1215, Bangladesh</a>
             <a href="tel:+880-2-55013420" class="footer-links"><i class="fas fa-phone"></i> +880-2-55013420</a>
             <a href="tel:+880-1711-000000" class="footer-links"><i class="fas fa-mobile"></i> +880-1711-000000</a>
             <a href="mailto:info@jobportal.com.bd" class="footer-links"><i class="fas fa-envelope"></i> info@jobportal.com.bd</a>
             <div class="social-links">
               <a href="https://www.facebook.com/jobportalbd" target="_blank" class="social-link"><i class="fab fa-facebook"></i></a>
               <a href="https://www.twitter.com/jobportalbd"  target="_blank" class="social-link"><i class="fab fa-twitter"></i></a>
               <a href="https://www.linkedin.com/company/jobportalbd"   target="_blank" class="social-link"><i class="fab fa-linkedin" ></i></a>
             </div>
            </div>
          </div>
        </div>
