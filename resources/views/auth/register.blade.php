    ...
    <div class="row justify-content-center">
        <div class="col-sm-12 col-md-6 px-0">
            ...
            <div class="login-poster">
                ...
                <p class="text-white mb-3 lead"><i class="fas fa-angle-right"></i> Most Trusted Job Portal in Rajshahi</p>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-6 px-0">
            <div class="login-container">
                <div class="login-header mb-3">
                    <h3><img src="{{asset('images/logo/jobportal.png')}}" width="50px;" alt=""> Create your free jobseeker account</h3>
                    ...
                    <form action="{{route('register')}}" method="POST">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input id="first_name" type="text" placeholder="First name" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required autocomplete="given-name" autofocus>
                                @error('first_name')
                        ...
                        <div>
                            <small class="text-muted d-block mb-3">By clicking on 'Create Jobseeker Account' below you are agreeing to the terms and privacy of JobPortal!</p>
                        </div>
